...
public class PedidoController {
    ...
    @Operation(summary = "Atualizar um pedido", description = "Recurso para atualizar o status de um pedido existente.")
    @ApiResponses(value = {
   ...
   public ResponseEntity<PedidoResponseDto> Atualizar(@PathVariable Long idPedido) {
    ...
    @Operation(summary = "Cancelar um pedido" ,
            description = "Recurso para cancelar um pedido por ID",
